...
def main() -> None:
    ...
    config_paths = [
        project_root / "configs" / "train_carson_sst2_run_001.yaml",
        project_root / "configs" / "train_identity_sst2_run_001.yaml",
        project_root / "configs" / "train_linear_sst2_run_001.yaml",
    ]
